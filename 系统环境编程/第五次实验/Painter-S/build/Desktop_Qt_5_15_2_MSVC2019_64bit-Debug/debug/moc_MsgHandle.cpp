/****************************************************************************
** Meta object code from reading C++ file 'MsgHandle.h'
**
...
#error "The header file 'MsgHandle.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 8, 5), // "Paint"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 8) // "bodyData"

    },
    "Session\0Paint\0\0bodyData"
};
...
void Session::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Paint((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Session::Paint)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Session::Paint(const QByteArray & _t1)
{
